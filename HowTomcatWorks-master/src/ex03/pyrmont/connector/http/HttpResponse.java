  ...
  public void sendStaticResource() throws IOException {
    ...
    try {
      ...
      */
      ...
      String type="";
      if(request.getRequestURI().substring(request.getRequestURI().lastIndexOf(".") + 1).equals("html")){
        type="text/html";
      }else if(request.getRequestURI().substring(request.getRequestURI().lastIndexOf(".") + 1).equals("gif")){
        type="image/png";
      }
